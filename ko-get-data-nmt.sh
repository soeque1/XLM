...
if [ "$TGT" != "de" -a "$TGT" != "en" -a "$TGT" != "fr" -a "$TGT" != "ro" -a "$TGT" != "ko" ]; then echo "unknown target language"; exit; fi
...
source /t2meta/user/soeque1/python/venv/rep-xlm/bin/activate
